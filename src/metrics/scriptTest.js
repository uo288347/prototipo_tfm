...
function registerhandedness(value) {postStringDD(271, value);}
function registerpassword(value) {postStringDD(272, value);}
function registersus3(value) {postNumberDD(273, value);}
function registerid(value) {postStringDD(274, value);}
function registerusername(value) {postStringDD(275, value);}
function registersus7(value) {postNumberDD(276, value);}
function registersus10(value) {postNumberDD(277, value);}
function registersus6(value) {postNumberDD(278, value);}
function registerbirth_year(value) {postNumberDD(279, value);}
function registersus9(value) {postNumberDD(280, value);}
function registersus2(value) {postNumberDD(281, value);}
function registerpreferred_device(value) {postStringDD(282, value);}
function registerecommerce_frequency(value) {postStringDD(283, value);}
function registercountry(value) {postStringDD(284, value);}
function registersus4(value) {postNumberDD(285, value);}
function registercity(value) {postStringDD(286, value);}
function registersus5(value) {postNumberDD(287, value);}
function registersus1(value) {postNumberDD(288, value);}
function registersex(value) {postStringDD(289, value);}
function registersus8(value) {postNumberDD(290, value);}
export {
