...
export const DynamicHead = () => {
  ...
  return (
    <Head>
      ...
      <meta property="og:image" content="https://carbayo.vercel.app/mascota_render_v6.png?v=2" />
      ...
      <meta name="twitter:image" content="https://carbayo.vercel.app/mascota_render_v6.png?v=2" />
    </Head>
  );
};